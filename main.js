...
document.getElementById(
  "header"
).innerHTML = ` <nav class="navbar navbar-expand-sm navbar-light bg-info">
<div class="container">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavId">
      <ul class="navbar-nav me-auto mt-2 mt-lg-0">
          ...
          <li class="nav-item">
              <a class="nav-link" href="https://vermillion-lily-d6e5e7.netlify.app/">Front End</a>
          </li>
          <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownId">
                  <a class="dropdown-item" href="productos.html">Eventos</a>
